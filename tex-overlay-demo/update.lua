...
local function bhv_shape_loop(o)
    ...
    if gControllers[0].buttonDown & Z_TRIG ~= 0 then return end
    -- if get_global_timer() % 10 ~= 0 then return end
    o.oPosX = m.pos.x + 160 * sins(o.oMoveAngleYaw + o.oAction * 0x5555)
    o.oPosY = m.pos.y + 80
    o.oPosZ = m.pos.z + 160 * coss(o.oMoveAngleYaw + o.oAction * 0x5555)
    local x = o.oTimer*0x900 + o.oAction * 0x5555
    o.header.gfx.scale.y = 1 + sins(x)/3
    o.header.gfx.scale.x = 1 + coss(x)/3
    o.header.gfx.scale.z = 1 + coss(x)/3
