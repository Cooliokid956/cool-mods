...
--            o.oVelY = 100
            ...
            o.oVelX = reflect.x*vec3f_dist(pos,vel)*o.oBounciness
            o.oVelY = reflect.y*vec3f_dist(pos,vel)*o.oBounciness
            o.oVelZ = reflect.z*vec3f_dist(pos,vel)*o.oBounciness
